...
import { faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faGauge, faPencil, faUsers, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function AdminMemberUpdate() {
    ...
    function onAdminMemberUpdateSuccess(response){
        ...
        setForceURL("/admin/branch/"+response.branchId+"/member/"+response.id);
    }
                ...
                <section class="section">
                    <nav class="breadcrumb" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/admin/branch/${bid}/member/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail</Link></li>
                        ...
                        {isFetching
                            ...
                            <div class="container" key={id}>
                                ...
                                <FormSelectFieldForBranch
                                    ...
                                    helpText="Please select the primary gym location to associate with this member"
                                    maxWidth="310px"
                                />
