                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <section class="hero is-medium has-background-white-ter">
                                          <div class="hero-body">
                                            ...
                                            <p class="subtitle">
                                                Empty waitlist. <b><Link to={`/admin/all/calendar`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating finding a full schedule to add the member to a waitlist.
                                            </p>
                                          </div>
                                    </section>
                                }
