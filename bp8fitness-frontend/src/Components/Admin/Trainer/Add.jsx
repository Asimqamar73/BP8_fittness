...
import { faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faChalkboardTeacher, faIdCard, faAddressBook, faMessage, faChartPie, faCogs } from '@fortawesome/free-solid-svg-icons'
import { useRecoilState } from 'recoil';

import { getTrainerDetailAPI, postTrainerCreateAPI } from "../../../API/trainer";
...
function AdminTrainerAdd() {
    ...
    const [howDidYouHearAboutUs] = useState(2); // 2 = Did not say / Prefer not to answer
    ...
    const onSubmitClick = (e) => {
        ...
        postTrainerCreateAPI(decamelizedData, onAdminTrainerAddSuccess, onAdminTrainerAddError, onAdminTrainerAddDone);
    }

    function onAdminTrainerAddSuccess(response){
        // For debugging purposes only.
        console.log("onAdminTrainerAddSuccess: Starting...");
        console.log(response);

        // Add a temporary banner message in the app and then clear itself after 2 seconds.
        setTopAlertMessage("Trainer created");
        setTopAlertStatus("success");
        setTimeout(() => {
            console.log("onAdminTrainerAddSuccess: Delayed for 2 seconds.");
            console.log("onAdminTrainerAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminTrainerAddError(apiErr) {
        console.log("onAdminTrainerAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onAdminTrainerAddError: Delayed for 2 seconds.");
            console.log("onAdminTrainerAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminTrainerAddDone() {
        console.log("onAdminTrainerAddDone: Starting...");
        setFetching(false);
    }
                        ...
                        <div class={`modal ${showCancelWarning ? 'is-active' : ''}`}>
                            ...
                            <div class="modal-card">
                                ...
                                <footer class="modal-card-foot">
                                    <Link class="button is-medium is-success" to={`/admin/trainers`}>Yes</Link>
                                    <button class="button is-medium" onClick={(e)=>setShowCancelWarning(false)}>No</button>
                                </footer>
                            </div>
                        </div>

                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Trainer</p>
                        ...
                        <div class="container">
                            ...
                            <div class="columns pt-5">
                                ...
                                <div class="column is-half has-text-right">
                                    <button class="button is-medium is-primary is-hidden-touch" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Create Trainer</button>
                                    <button class="button is-medium is-primary is-fullwidth is-hidden-desktop" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Create Trainer</button>
                                </div>
                            </div>
