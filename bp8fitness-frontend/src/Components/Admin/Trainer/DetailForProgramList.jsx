...
import { faDumbbell, faChalkboardTeacher, faGauge, faEye, faPencil, faTrashCan, faPlus, faArrowRight, faTable, faArrowUpRightFromSquare, faFilter, faSearch, faRefresh } from '@fortawesome/free-solid-svg-icons';
...
function AdminTrainerDetailForProgramList() {
    ////
    //// URL Parameters.
    ////
    ...
    const [branchID] = useState(bid);                                       // Filtering (Override)
    ...
    const [trainerID] = useState(tid);                                       // Filtering (Override)
                ...
                <section class="section">
                    <nav class="breadcrumb" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Classes)</Link></li>
                        </ul>
                    </nav>
                    <nav class="box">
                        <div class={`modal ${selectedWorkoutProgramForDeletion ? 'is-active' : ''}`}>
                            ...
                            <div class="modal-card">
                                ...
                                <section class="modal-card-body">
                                    You are about to <b>archive</b> this workout class; it will no longer appear on your dashboard. This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?
                                </section>
                        ...
                        <div class="columns is-mobile">
                            <div class="column">
                                <h1 class="title is-4"><FontAwesomeIcon className="fas" icon={faChalkboardTeacher} />&nbsp;Trainer</h1>
                            </div>
                            <div class="column has-text-right">
                                ...
                                &nbsp;
                                <Link to={`/admin/classes/add?bid=${bid}&tid=${tid}`} class="button is-small is-primary" type="button">
                        ...
                        {isFetching
                            ...
                            : <>
                                <div class="tabs is-medium">
                                    <ul>
                                        <li class="is-active">
                                            <Link to={`/admin/branch/${bid}/trainer/${tid}`}>Detail</Link>
                                        </li>
                                        <li>
                                            <Link><strong>Classes</strong></Link>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                                                ...
                                                                return <tr>
                                                                    ...
                                                                    <td class="is-actions-cell">
                                                                        <div class="buttons is-right">
                                                                            <Link to={`/admin/branch/${datum.branchId}/workouts/program/${datum.id}`} class="button is-small is-primary" type="button" target="_blank" rel="noreferrer">
                                                                                <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                                                                            </Link>
                                                                            <Link to={`/admin/branch/${datum.branchId}/workouts/program/${datum.id}/update`}  class="button is-small is-warning" type="button" target="_blank" rel="noreferrer">
                                    ...
                                    <section class="hero is-medium has-background-white-ter">
                                          <div class="hero-body">
                                            ...
                                            <p class="subtitle">
                                                No classes. <b><Link to={`/admin/classes/add?bid=${bid}&tid=${tid}`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your first class for this trainer.
                                            </p>
                                          </div>
                                    </section>
                                }
...
export default AdminTrainerDetailForProgramList;
