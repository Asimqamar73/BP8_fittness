...
import { faDumbbell, faGauge, faSearch, faEye, faPencil, faTrashCan, faPlus, faArrowRight, faTable, faArrowUpRightFromSquare, faFilter, faRefresh, faTrash } from '@fortawesome/free-solid-svg-icons';
...
function AdminWorkoutProgramSessionWaitlisterList() {
    ////
    //// URL Parameters.
    ////
    ...
    const [workoutSessionID, setWorkoutSessionID] = useState(sid);       // Filtering
    ...
    useEffect(() => {
        ...
        if (mounted) {
            ...
            fetchList(currentCursor, pageSize, actualSearchText, branchID, workoutProgramID, workoutSessionID, trainerID, startAt);
    ...
    }, [sid, currentCursor, pageSize, actualSearchText, branchID, workoutProgramID, workoutSessionID, trainerID, startAt]);
                ...
                <section class="section">
                    <nav class="breadcrumb" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Schedule Detail (Waitlist)</Link></li>
                        </ul>
                    </nav>
                    <nav class="box">
                        <div class={`modal ${selectedWorkoutSessionForDeletion ? 'is-active' : ''}`}>
                            ...
                            <div class="modal-card">
                                ...
                                <section class="modal-card-body">
                                    You are about to <b>permanently delete</b> this waitlister from this session; it will no longer appear on your dashboard. This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?
                                </section>
                        ...
                        <div class="columns is-mobile">
                            ...
                            <div class="column has-text-right">
                                <button onClick={()=>fetchList(currentCursor, pageSize, actualSearchText, branchID, workoutProgramID, workoutSessionID, trainerID, startAt)} class="button is-small is-info" type="button">
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                                                ...
                                                                return <tr>
                                                                    ...
                                                                    <td class="is-actions-cell">
                                                                        <div class="buttons is-right">
                                                                            ...
                                                                            <Link to={`/admin/branch/${datum.branchId}/class/${datum.workoutProgramId}/session/${datum.workoutSessionId}/waitlister/${datum.id}`} class="button is-small is-primary" type="button">
                                    ...
                                    <section class="hero is-medium has-background-white-ter">
                                          <div class="hero-body">
                                            ...
                                            <p class="subtitle">
                                                No waitlisters in this session. <b><Link to={`/admin/branch/${bid}/class/${pid}/session/${sid}/waitlisters/add`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started helping a member join this session's waitlist.
                                            </p>
                                          </div>
                                    </section>
                                }
...
export default AdminWorkoutProgramSessionWaitlisterList;
