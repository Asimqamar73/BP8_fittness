...
import { getWorkoutSessionWaitlisterDetailAPI } from "../../../../../API/WorkoutSessionWaitlister";
...
function AdminWorkoutProgramSessionWaitlisterDetail() {
    ////
    //// URL Parameters.
    ////

    const { bid, pid, sid, wid } = useParams()
    ...
    //         getWorkoutSessionWaitlisterDetailAPI(
    //             wpID,
    //             onWorkoutSessionWaitlisterDetailSuccess,
    //             onWorkoutSessionWaitlisterDetailError,
    //             onWorkoutSessionWaitlisterDetailDone
    //         );
    //     } else {
    //         setWorkoutProgram({});
    //     }
    ...
    const onWorkoutSessionWaitlisterDetailSuccess = (response) => {
        console.log("onWorkoutSessionWaitlisterDetailSuccess: Starting...");
        if (response !== undefined && response !== null && response !== "") { // Defensive code.
            setDatum(response);
        }
    }

    const onWorkoutSessionWaitlisterDetailError = (apiErr) => {
        console.log("onWorkoutSessionWaitlisterDetailError: Starting...");
        setErrors(apiErr);
    ...
    const onWorkoutSessionWaitlisterDetailDone = () => {
        console.log("onWorkoutSessionWaitlisterDetailDone: Starting...");
        setFetching(false);
    }
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Waitlister Detail</p>
                        ...
                        {isFetching
                            ...
                            <>{datum && <div class="container">
                                ...
                                */}
                                ...
                                <p class="subtitle is-6"><FontAwesomeIcon className="fas" icon={faCogs} />&nbsp;Waitlister Details</p>
                                <hr />

                                <div class="field pb-4">
                                    <label class="label">Waitlister ID</label>
                                    <div class="control">
                                        <p>{wid}</p>
                                    </div>
                                    <p class="help">The unique identifier used in our system for this waitlister record.</p>
                                </div>
                                ...
                                <div class="columns pt-5">
                                    <div class="column is-half">
                                        <Link to={`/admin/branch/${bid}/class/${pid}/session/${sid}/waitlisters`} class="button is-medium is-hidden-touch"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        <Link to={`/admin/branch/${bid}/class/${pid}/session/${sid}/waitlisters`} class="button is-medium is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                    </div>
                                    <div class="column is-half has-text-right">
                                    {/*
                                        <Link to={`/admin/branch/${datum.branchId}/class/${datum.workoutProgramId}/session/${datum.workoutSessionId}/waitlister/${datum.id}/update`} class="button is-medium is-primary is-hidden-touch"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                        <Link to={`/admin/branch/${datum.branchId}/class/${datum.workoutProgramId}/session/${datum.workoutSessionId}/waitlister/${datum.id}/update`} class="button is-medium is-primary is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                    */}
                                    </div>
                                </div>
...
export default AdminWorkoutProgramSessionWaitlisterDetail;
