...
import { postWorkoutSessionBookingCreateAPI } from "../../../../../API/WorkoutSessionBooking";
...
function AdminWorkoutProgramSessionBookingAdd() {
    ////
    //// URL Parameters.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        postWorkoutSessionBookingCreateAPI(data, onAdminWorkoutProgramSessionBookingAddSuccess, onAdminWorkoutProgramSessionBookingAddError, onAdminWorkoutProgramSessionBookingAddDone);
    }

    const onAdminWorkoutProgramSessionBookingAddSuccess = (response) => {
        // For debugging purposes only.
        console.log("onAdminWorkoutProgramSessionBookingAddSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onAdminWorkoutProgramSessionBookingAddSuccess: Delayed for 2 seconds.");
            console.log("onAdminWorkoutProgramSessionBookingAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    const onAdminWorkoutProgramSessionBookingAddError = (apiErr) => {
        console.log("onAdminWorkoutProgramSessionBookingAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onAdminWorkoutProgramSessionBookingAddError: Delayed for 2 seconds.");
            console.log("onAdminWorkoutProgramSessionBookingAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    const onAdminWorkoutProgramSessionBookingAddDone = () => {
        console.log("onAdminWorkoutProgramSessionBookingAddDone: Starting...");
        setFetching(false);
    }
                ...
                <section class="section">
                    <nav class="breadcrumb" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Booking</Link></li>
                        </ul>
                    </nav>
                    <nav class="box">
                        ...
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Booking</p>
...
export default AdminWorkoutProgramSessionBookingAdd;
