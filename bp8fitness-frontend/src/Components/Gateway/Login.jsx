...
function Login() {
    ...
    function onLoginSuccess(response){
        ...
        if (response.user === undefined || response.user === null || response.user === "") { // Defensive code.
        ...
        switch(response.user.role) {
            case 1:
                console.log("onLoginSuccess: user is executive (root) admin, redirecting to admin dashboard...");
                ...
                break;
            case 2:
                console.log("onLoginSuccess: user is admin, redirecting to admin dashboard...");
                setForceURL("/admin/dashboard");
                break;
            case 3:
                console.log("onLoginSuccess: user is trainer, redirecting to trainer dashboard...");
                setForceURL("/trainer/dashboard");
                break;
            case 4:
                console.log("onLoginSuccess: user is member, redirecting to member dashboard...");
