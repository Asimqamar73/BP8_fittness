...
function RegisterStep2() {
    ...
    const branchID = searchParams.get("bid");
        ...
        <>
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Register - Step 2 of 2</p>
                        ...
                        {!isFetching && <div class="container">
                            ...
                            <div class="columns">
                                <div class="column is-half">
                                    <Link to={`/register-step-1`} class="button is-medium is-hidden-touch"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                    <Link to={`/register-step-1`} class="button is-medium is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                </div>
